...
public class TaskProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case TASKS:
                cursor = sqLiteDatabase.query(DatabaseContract.TABLE_NAME, projection, null, null, null, null, sortOrder);
                break;
            case TASKS_WITH_ID:
                selection = DatabaseContract.TaskColumns._ID + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};

                cursor = sqLiteDatabase.query(DatabaseContract.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        final SQLiteDatabase db = mDbHelper.getWritableDatabase();
        int id = db.update(DatabaseContract.TABLE_NAME, values, selection, selectionArgs);
        if (id > 0) {
            //Notify observers of the change
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int count = db.delete(DatabaseContract.TABLE_NAME, selection, selectionArgs);
