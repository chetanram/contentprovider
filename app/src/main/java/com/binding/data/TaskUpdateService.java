...
import com.binding.reminders.AlarmScheduler;
import com.binding.reminders.ReminderAlarmService;
...
public class TaskUpdateService extends IntentService {
    ...
    private void performInsert(ContentValues values) {
       ...
       /* if (uri != null) {
            long date=values.getAsLong(DatabaseContract.TaskColumns.DUE_DATE);
            //set reminder for task on due date
            AlarmScheduler.scheduleAlarm(getApplicationContext(),date,uri);
